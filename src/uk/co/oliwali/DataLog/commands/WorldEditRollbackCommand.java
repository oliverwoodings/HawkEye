...
public class WorldEditRollbackCommand extends BaseCommand {
	...
	public boolean execute() {
		...
		Thread thread = new SearchQuery(SearchType.ROLLBACK, sender, dateFrom, dateTo, players, actions, region.getMinimumPoint(), region.getMaximumPoint(), worlds, filters, "desc");
		thread.start();
		return true;
	}
